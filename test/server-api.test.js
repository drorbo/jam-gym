...
test('the Keys and Drums panels are stored with the track; junk is repaired and older tracks get the style default', withServer(async ({ browser }) => {
  ...
  const kit = { levels: { kick: 70, snare: 50, hat: 20, ride: 50, crash: 0, toms: 50, brush: 50 }, groove: 'purdie', snareSound: 'rim', clave: 'rumba23', cymbal: 10, kick: 90, snare: 70, ghosts: 0, fills: 100, wild: 100, crash: 0, power: 80, pocket: 40, loose: 90 };
